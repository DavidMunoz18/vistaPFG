		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					...
					<li class="nav-item cart-container"><a href="<%=request.getContextPath()%>/carrito"> 
		...
		<div class="row">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<button class="btn btn-link nav-link"
							onclick="mostrarSeccion('agregarProducto')">Agregar Productos</button>
					</li>
					<li class="nav-item">
						<button class="btn btn-link nav-link"
					...
					<li class="nav-item">
						<button class="btn btn-link nav-link"
							onclick="mostrarSeccion('agregarMarca')">Agregar Marca Colaboradora</button>
					</li>
					<li class="nav-item">
						<button class="btn btn-link nav-link"
			...
			<div class="col-md-9 py-4">
							...
							<tr>
								...
								<td>
									...
									<form method="get" style="display: inline;">
										...
										<input type="hidden" name="nombre" value="<%=marca.getNombre()%>">
										<input type="hidden" name="paisOrigen" value="<%=marca.getPaisOrigen()%>">
										<input type="hidden" name="anioFundacion" value="<%=marca.getAnioFundacion()%>">
										<input type="hidden" name="descripcion" value="<%=marca.getDescripcion()%>">
										<button type="submit" title="Editar" style="border: none; background: none;">
									...
									<form action="eliminarMarca" method="post" style="display: inline;">
										<input type="hidden" name="id" value="<%=marca.getId()%>">
										<button type="submit" style="border: none; background: none;" title="Eliminar"
				...
				<div id="modificarMarca" class="seccion" style="display: block;">
					...
					<form action="modificarMarcas" method="post">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="idMarca" name="id" value="<%=id%>" readonly>
						</div>
						<div class="mb-3">
							<label for="nombreMarca" class="form-label">Nombre:</label>
							<input type="text" class="form-control" id="nombreMarca" name="nombre" value="<%=nombre%>" required>
						</div>
						<div class="mb-3">
							<label for="paisOrigenMarca" class="form-label">País de Origen:</label>
							<input type="text" class="form-control" id="paisOrigenMarca" name="paisOrigen" value="<%=paisOrigen%>" required>
						</div>
						<div class="mb-3">
							<label for="anioFundacionMarca" class="form-label">Año de Fundación:</label>
							<input type="number" class="form-control" id="anioFundacionMarca" name="anioFundacion" value="<%=anioFundacion%>" required>
						</div>
						<div class="mb-3">
							<label for="descripcionMarca" class="form-label">Descripción:</label>
							<textarea class="form-control" id="descripcionMarca" name="descripcion" rows="3" required><%=descripcion%></textarea>
						</div>
				...
				<div id="agregarProducto" class="seccion" style="display: none;">
					...
					<form action="productosAniadir" method="post" enctype="multipart/form-data">
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							if (marcas != null) {
							%>
							<p>Número de marcas: <%=marcas.size()%></p>
							<%
							}
							%>
							<select class="form-select" id="marcaProducto" name="idMarca" required onchange="mostrarDetallesMarca()">
								<option value="">Seleccionar Marca</option>
								<%
								if (marcas != null && !marcas.isEmpty()) {
									for (MarcaDto marca : marcas) {
								%>
								<option value="<%=marca.getId()%>" data-pais="<%=marca.getPaisOrigen()%>" data-anio="<%=marca.getAnioFundacion()%>">
									<%=marca.getNombre()%>
								</option>
								<%
									}
						...
						<div class="mb-3" id="marcaDetalles">
							<p><strong>País de Origen:</strong> <span id="paisMarca"></span></p>
							<p><strong>Año de Fundación:</strong> <span id="anioFundacionMarca"></span></p>
						</div>
						<input type="hidden" id="paisMarcaInput" name="pais">
						<input type="hidden" id="anioMarcaInput" name="anioCreacion">
						<input type="hidden" id="marcaNombreInput" name="marcaNombre">
						<div class="mb-3">
				...
				<div id="agregarMarca" class="seccion" style="display: none;">
					...
					<form action="marcasAniadir" method="post">
						...
						<input type="number" id="anioFundacion" name="anioFundacion" required>
						<label for="descripcion">Descripción:</label>
						<textarea id="descripcion" name="descripcion" required></textarea>
						<button type="submit" class="btn btn-success mt-3">Agregar Marca</button>
					</form>
				</div>
				...
				<div id="modificarProducto" class="seccion" style="display: none;">
					...
					<form action="modificarProducto" method="post" enctype="multipart/form-data">
						<div class="mb-3">
							...
							<input type="number" id="idProducto" name="id" class="form-control" required readonly>
						</div>
						<div class="mb-3">
							<label for="modNombreProducto" class="form-label">Nombre (opcional):</label>
							<input type="text" id="modNombreProducto" name="nombre" class="form-control">
						</div>
						<div class="mb-3">
							<label for="modDescripcionProducto" class="form-label">Descripción (opcional):</label>
							<textarea id="modDescripcionProducto" name="descripcion" class="form-control" rows="3"></textarea>
						</div>
						<div class="mb-3">
							<label for="modPrecioProducto" class="form-label">Precio (opcional):</label>
							<input type="number" id="modPrecioProducto" name="precio" class="form-control" step="0.01">
						</div>
						<div class="mb-3">
							<label for="modStockProducto" class="form-label">Stock (opcional):</label>
							<input type="number" id="modStockProducto" name="stock" class="form-control">
						</div>
						<div class="mb-3">
						...
						<button type="submit" class="btn btn-warning mt-3">Modificar Producto</button>
					</form>
				</div>
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><!-- Se puede mostrar la imagen aquí --></td>
								<td>
									<i class="fas fa-edit" style="cursor: pointer; color: blue;"
									...
									<i class="fas fa-trash-alt" style="cursor: pointer; color: red;"
										onclick="eliminarProducto('<%=producto.getId()%>')"></i>
								</td>
							</tr>
							<%
								}
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<!-- Actualización para pasar el email al llamar a eliminarUsuario -->
									<i class="fas fa-trash-alt" style="cursor: pointer; color: red;"
										onclick="eliminarUsuario('<%=usuario.getIdUsuario()%>', '<%=usuario.getEmailUsuario()%>')"></i>
								</td>
							</tr>
							<%
								}
