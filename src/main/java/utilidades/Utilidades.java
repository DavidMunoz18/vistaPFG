...
/**
 * Clase de utilidades para operaciones comunes como el envío de correos electrónicos
 * y la escritura de logs en archivos individuales por sesión.
 * <p>
 * Incluye:
 * <ul>
 *   <li>Envío de correos electrónicos mediante JavaMail usando SMTP (Gmail).</li>
 *   <li>Escritura de logs en archivos separados por ID de sesión y fecha.</li>
 *   <li>Configuración estática de {@link MailcapCommandMap} para registrar los manejadores MIME necesarios.</li>
 * </ul>
 * </p>
 */
public class Utilidades {
	...
	/**
	 * Escribe un log en un fichero único por sesión. El nombre del fichero incluye
	 * el ID de la sesión y la fecha actual.
	 *
	 ...
	 * @param mensaje Mensaje a registrar en el log.
	 */
	public static void escribirLog(jakarta.servlet.http.HttpSession session, String nivel, String clase, String metodo,
			String mensaje) {

		if (session == null) {
			System.out.println(
					"Nivel: " + nivel + " - Clase: " + clase + " - Método: " + metodo + " - Mensaje: " + mensaje);
		...
		final String RUTA_BASE = "C:" + java.io.File.separator + "Users" + java.io.File.separator + "david"
				+ java.io.File.separator + "OneDrive" + java.io.File.separator + "Documentos" + java.io.File.separator
				+ "vistaPFV1" + java.io.File.separator + "fichero" + java.io.File.separator;
